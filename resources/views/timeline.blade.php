...
<div class="">
  ...
  <nav class=" navbar navbar-expand navbar-dark navbar-black">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link btn btn-secondary" href="logout">logout <i class="fas fa-out-alt"></i></a>
      </li>
          ...
          <div class="col-md-12">
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                     <img class="img-fluid" src="{{ asset('images/'.$galery->foto) }}" width="150" height="150" alt="photo">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="header">
                    <h2 class="modal-tittle" > Hapus Foto</h2>
                  </div>
                  <div class="modal-body">
                    <p>Yakin Ingin Menghapus?</p>
                    <div class="modal-footer">
                      <a href="{{ url('galery/'.$galery->id) }}" class="btn btn-primary" type="submit">Delete</a>
                      <button class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                  </div>
                </div>
